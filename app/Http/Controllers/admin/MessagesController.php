...
class MessagesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sidebar.messenger.index', compact('threads'));
    }
    ...
    public function show(Thread $thread)
    {
        ...
        return view('sidebar.messenger.show', compact('thread'));
    }
    ...
    public function create()
    {
        ...
        return view('sidebar.messenger.create', compact('users'));
    }
